    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="subirDocumentosLabel">Documentos acreditación examen CENEVAL</h5>
                ...
                <form id="formEditar" method="POST" action="{{ route('uploadDocuments') }}"
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="mb-3">
                                <label for="tituloProyecto" class="campoTitulo">Oficio CENEVAL</label>
                            </div>
                            <div class="mb-3">
                                <label for="tituloProyecto" class="campoTitulo">Testimonio CENEVAL</label>
                            </div>
                            <div class="mb-3">
